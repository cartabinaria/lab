...
capybara  castoro
  ...
  La flag \texttt{-d} del comando \texttt{ls} permette di non mostrare i contenuti delle
  sotto  directory \bigskip

  Perché dobbiamo metterla se vogliamo elencare solo gli elementi della directory corrente?
