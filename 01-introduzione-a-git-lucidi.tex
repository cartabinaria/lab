...
\begin{frame}{Ambiente di lavoro | Preparazione (3)}
  \begin{enumerate}
    ...
    \end{semiverbatim}
    \begin{semiverbatim}
        \qquad"stefano.volpe@studio.unibo.it"
    \end{semiverbatim}
  \end{enumerate}
\end{frame}
...
\begin{frame}{\texttt{git init}}
  ...
  \texttt{<directory>/.git/}; se \texttt{<directory>} non è specificata, viene
...
\begin{frame}{\texttt{git status}}
  \begin{figure}
    \includegraphics[width=\textwidth]{assets/lifecycle.png}
...
\begin{frame}{\texttt{git add}}
  \begin{figure}
    \includegraphics[width=\textwidth]{assets/lifecycle-add.png}
  \end{figure}
...
\begin{frame}{\texttt{git commit}}
  \begin{figure}
    \includegraphics[width=\textwidth]{assets/lifecycle-commit.png}
  \end{figure}
  ...
  specificare il messaggio. Con \texttt{--amend}, correggo il \emph{commit}
  precedente.
\end{frame}
...
\begin{frame}{\texttt{git log}}
  ...
  \end{semiverbatim}
  \begin{itemize}
    \item<1-> \texttt{-p} mostra le differenze che ciascun \emph{commit} ha
      introdotto;
    \item<2-> \texttt{-<n>} mostra solo gli ultimi \texttt{<n>} \emph{commit};
    \item<3-> \texttt{--stat} e \texttt{--shortstat} mostrano statistiche;
    \item<4-> \texttt{--graph} disegna un grafo;
    \item<4-> \dots
  \end{itemize}
\end{frame}
